...
joe.suite('fellow', function (suite, test) {
	const name = 'Benjamin Lupton', email = 'b@lupton.cc', homepage = 'https://balupton.com', homepage2 = 'http://balupton.com', githubUrl = 'https://github.com/balupton'
	...
	suite('singleton', function (suite, test) {
		test('ensure first instance into the singleton', function () {
			...
			equal(Fellow.list.length, 3, 'three fellows still exist, a new one was not added, 5')
