...
``` typescript
import pkg from 'https://unpkg.com/fellow@^6.13.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/fellow/^6.13.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/fellow@^6.13.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/fellow@6.13.0'
</script>
```
